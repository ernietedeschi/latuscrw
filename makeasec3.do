...
recode nativity (0/4 = 1 "Born US") (5 = 2 "Foreign Born"), gen(bornus)

ren marst maritalstatus
...
preserve
collapse (percent) constant [iw=wtsupp], by(bornus)
ren constant bornusp
save bornusps, replace
restore

preserve
collapse (percent) constant [iw=wtsupp], by(maritalstatus)
ren constant maritalstatusp
save maritalstatusps, replace
restore
